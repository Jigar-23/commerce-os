...
public class UserAccount {
    ...
    public UserAccount(UUID id, String email, String phone, String passwordHash, String fullName, Set<String> roles, String accountStatus, Boolean emailVerified, Boolean phoneVerified, Integer failedLoginAttempts, Instant lockoutUntil, Boolean mfaEnabled, String mfaSecretKey, Instant createdAt, Instant updatedAt) {
        this.id = id;
        this.email = email;
        this.phone = phone;
    ...
    public String getMfaSecretKey() { return mfaSecretKey; }
    public void setMfaSecretKey(String mfaSecretKey) { this.mfaSecretKey = mfaSecretKey; }
    ...
    public static class UserAccountBuilder {
        ...
        public UserAccountBuilder failedLoginAttempts(Integer failedLoginAttempts) { this.failedLoginAttempts = failedLoginAttempts; return this; }
        public UserAccountBuilder lockoutUntil(Instant lockoutUntil) { this.lockoutUntil = lockoutUntil; return this; }
        public UserAccountBuilder mfaEnabled(Boolean mfaEnabled) { this.mfaEnabled = mfaEnabled; return this; }
        public UserAccountBuilder mfaSecretKey(String mfaSecretKey) { this.mfaSecretKey = mfaSecretKey; return this; }
        ...
        public UserAccount build() {
            return new UserAccount(id, email, phone, passwordHash, fullName, roles, accountStatus, emailVerified, phoneVerified, failedLoginAttempts, lockoutUntil, mfaEnabled, mfaSecretKey, createdAt, updatedAt);
        }
    }
}
