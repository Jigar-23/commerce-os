    ...
    <>
      ...
      <aside className="w-16 bg-surface-inverse flex flex-col items-center py-5 justify-between shrink-0 z-30 shadow-2xl">
        <div className="flex flex-col items-center space-y-6">
          ...
          <Link href="/riders" title="Fleet & Riders">
            <div className={`p-3 rounded-xl transition-all ${activeTab === 'riders' ? 'bg-surface-accentSubtle text-content-accent border border-border-accent shadow-inner' : 'text-content-muted hover:text-white hover:bg-surface-inverse'}`}>
      ...
      <aside className="w-64 bg-white border-r border-border-default flex flex-col justify-between shrink-0 shadow-sm">
        <div className="p-6 space-y-6">
          ...
          <nav className="space-y-1.5">
            ...
            <Link href="/riders" className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-semibold transition-all ${activeTab === 'riders' ? 'bg-surface-accentSubtle text-content-accent font-bold' : 'text-content-secondary hover:bg-surface-subtle'}`}>
              <div className="flex items-center space-x-3">
