...
/**
 * Keystore-backed encrypted credential store for Rider App.
 * Values are AES/GCM-encrypted with a per-alias key held in AndroidKeyStore;
 * only ciphertext ever touches SharedPreferences. Used to persist Rider
 * JWT access/refresh tokens securely.
 */
class RiderSecureCredentialStore(context: Context) {
    ...
    companion object {
        private const val PREFS_NAME = "com.commerceos.rider.secure_credentials"
