...
struct ClientTheme: Codable {
    ...
    var primaryDark: Color { Color(hex: "#0C831F") }
    var primarySoft: Color { Color(hex: "#EAF8E8") }
    var homeGrid: Color { Color(hex: "#F4F5F7") }
    var sushiInk: Color { Color(hex: "#1C1C1C") }
    var speedYellow: Color { Color(hex: "#E9BE3A") }
}
...
struct ClientTerminology: Codable {
    var appTitle: String { "Commerce OS" }
    var orderLabel: String { "Orders" }
