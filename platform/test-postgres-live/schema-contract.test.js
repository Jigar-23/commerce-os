...
const REQUIRED_COLUMNS = {
  ...
  delivery_sessions: ['id', 'delivery_id', 'order_id', 'rider_id', 'state', 'merchant_name', 'merchant_address', 'merchant_lat', 'merchant_lng', 'customer_name', 'customer_address', 'customer_lat', 'customer_lng', 'is_cod', 'cod_amount', 'otp_verified', 'waypoints', 'route_version', 'remaining_duration_mins'],
  ...
  rider_telemetry: ['id', 'rider_id', 'delivery_id', 'sequence_number', 'latitude', 'longitude', 'heading', 'speed', 'accuracy', 'recorded_at'],
